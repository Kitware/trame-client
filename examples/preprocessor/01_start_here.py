...
with SinglePageLayout(server) as ui:
    ...
    with (
        ...
        # 2. Instantiate the PreProcessor widget
        client.PreProcessor(
        ...
        vuetify3.VFileInput(
            ...
            # preprocessing.input_data value is a provided slot scopped reactive value which is observed by the PreProcessor component
